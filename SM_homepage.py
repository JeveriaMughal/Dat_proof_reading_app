...
def app():
    ...
    with column1:
        st.metric(label="Director General NLPD / Project Director NLP-Lab", value="Prof. Dr. Mohammmad Saleem Mazhar", delta="Language Expert", delta_color="normal", help=None)
    with column2:
